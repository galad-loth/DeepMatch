...
class LossHinge(mx.operator.NumpyOp):
    def __init__(self):
        super(LossHinge, self).__init__(False)
...
class LossHingeSiam(mx.operator.NumpyOp):
    def __init__(self,margin):
        super(LossHingeSiam, self).__init__(False)
        self.margin=margin
...
class LossTriplet(mx.operator.NumpyOp):
    def __init__(self, margin):
        super(LossTriplet, self).__init__(False)
        self.margin=margin
...
class LossTripletRatio(mx.operator.NumpyOp):
    def __init__(self, margin):
        super(LossTripletRatio, self).__init__(False)
        self.margin=margin
...
class LossEmbedGlobal(mx.operator.NumpyOp):
      def __init__(self):
        super(LossTripletRatio, self).__init__(False)      
        
class LossSoftPN(mx.operator.NumpyOp):
      def __init__(self):
        super(LossTripletRatio, self).__init__(False)